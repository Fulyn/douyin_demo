...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        channelPager = findViewById(R.id.channelPager)
        channelScrollView = findViewById(R.id.channelScrollView)
    ...
    private fun setupChannelBar() {
        ...
        channels.forEachIndexed { index, channel ->
            val channelTextView = TextView(this).apply {
                text = channel.title
    ...
    private fun setupChannelPager() {
        ...
        channelPager.registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
            ...
            override fun onPageSelected(position: Int) {
                ...
                channelPager.post { playCurrentVideo() }
            }
        })
    ...
    private fun playCurrentVideo() {
        if (!::channelPagerAdapter.isInitialized) return
    ...
    private inner class ChannelViewHolder(
        ...
        fun playCurrentVideo() {
            val holder = videoAdapter?.holderFor(videoPager.currentItem)
    ...
    private inner class VideoViewHolder(
        ...
        private fun preparePlayer(rawResId: Int) {
            ...
            val videoPlayer = player ?: ExoPlayer.Builder(this@MainActivity).build().also {
